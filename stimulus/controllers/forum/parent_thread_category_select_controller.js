...
export default class extends SelectController {
    ...
    submitBtnId = 'forum-thread-submit-button'
    turboFrameId = 'thread-categories'
    ...
    getOptionsForSlimSelect() {
        ...
        return {
            ...
            onChange: (info) => {
                const turboFrameContainer = document.getElementById('thread-categories')
                ...
                turboFrameContainer.setAttribute('src', `${this.urlValue}?parent_thread_category=${info.value}`)
